<#
    Eigenverft.Manifested.Sandbox.PackageModel.Cmd.Qwen35_2B_Q6K
#>

function Invoke-PackageModel-Qwen35-2B-Q6K {
<#
.SYNOPSIS
...
.EXAMPLE
Invoke-PackageModel-Qwen35-2B-Q6K
#>
    [CmdletBinding()]
    param()

    return (Invoke-PackageModelDefinitionCommand -DefinitionId 'Qwen35_2B_Q6K' -CommandName 'Invoke-PackageModel-Qwen35-2B-Q6K')
}
