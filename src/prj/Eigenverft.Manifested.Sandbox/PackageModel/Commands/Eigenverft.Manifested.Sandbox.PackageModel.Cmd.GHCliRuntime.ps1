<#
    Eigenverft.Manifested.Sandbox.PackageModel.Cmd.GHCliRuntime
#>

function Invoke-PackageModel-GHCliRuntime {
<#
.SYNOPSIS
...
.EXAMPLE
Invoke-PackageModel-GHCliRuntime
#>
    [CmdletBinding()]
    param()

    return (Invoke-PackageModelDefinitionCommand -DefinitionId 'GHCliRuntime' -CommandName 'Invoke-PackageModel-GHCliRuntime')
}
