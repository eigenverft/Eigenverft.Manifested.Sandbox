...
#>
    ...
    function Write-ProxyResolutionDiagnostic {
        param(
    ...
    function Get-AcceptAllCertificateReadinessCallback {
...
'@
    ...
    function Test-IsCertificateReadinessFailure {
        param(
            [Parameter(Mandatory = $true)]
    ...
    function Apply-StoredProfileToGlobal {
        [Diagnostics.CodeAnalysis.SuppressMessage("PSUseApprovedVerbs","")]
        param(
            [Parameter(Mandatory = $true)]
            [pscustomobject]$StoredProfile,
    ...
    function Test-Access {
        ...
        $certificateReadinessBypassActive = [bool]$effectiveSkipCertificateCheck
        ...
        while ($true) {
            ...
            try {
                ...
                if ($certificateReadinessBypassActive -and $null -ne $acceptAllCallback) {
                ...
                $isCertificateReadinessFailure = Test-IsCertificateReadinessFailure -Exception $_.Exception
                if (
                    -not $certificateReadinessBypassActive -and
                    ...
                    $certificateReadinessBypassActive = $true
                    continue
                }
    ...
    function Get-LocalRelayProxyCandidate {
        return @(
    ...
    function Test-PersistedProfile {
        ...
        switch ($mode) {
            'Direct' {
                ...
                $direct = Test-Access -Uri $ReadinessUri -TimeoutSec $TimeoutSec -Proxy $noProxy
            ...
            'EnvironmentProxy' {
                ...
                try {
                    ...
                    $result = Test-Access -Uri $ReadinessUri -TimeoutSec $TimeoutSec -Proxy $environmentProxy
            ...
            'LocalRelayProxy' {
                ...
                try {
                    ...
                    $result = Test-Access -Uri $ReadinessUri -TimeoutSec $TimeoutSec -Proxy $proxyObject
            ...
            'SystemProxyDefaultCredentials' {
                try {
                    ...
                    $result = Test-Access -Uri $ReadinessUri -TimeoutSec $TimeoutSec -Proxy $systemProxy
            ...
            'ManualProxy' {
                ...
                try {
                    ...
                    $result = Test-Access -Uri $ReadinessUri -TimeoutSec $TimeoutSec -Proxy $manualProxy
    ...
    try {
        ...
        if ($effectiveSkipCertificateCheck -or $automaticCertificateFallbackAllowed) {
            $acceptAllCallback = Get-AcceptAllCertificateReadinessCallback
        }
        ...
        if (-not $ForceRefresh) {
            ...
            if ($null -ne $storedProfile) {
                $persistedReadiness = Test-PersistedProfile `
                    -StoredProfile $storedProfile `
                    -ReadinessUri $TestUri `
