...
<!-- Auto-start: PowerShell startup invokes the proxy management function. The Initialize-ProxyCompact and Initialize-Bootstrap commands from Eigenverft.Manifested.Drydock are embedded here in compressed form so they remain within the 8 KB console command-line limit. -->
  <LogonCommand>
